...
/**
 * @typedef {Module} PluginModuleMeta Meta information generated by the plugin.
...
class AssetCompiler {
  ...
  beforeResolve(resolveData) {
    ...
    const meta = {
      entryId: AssetEntry.resolveEntryId(resolveData),
  ...
  beforeLoader(loaderContext, module) {
    const { entryId, isLoaderImport } = module.resourceResolveData._bundlerPluginMeta;
