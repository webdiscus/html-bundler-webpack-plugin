...
describe('watch exceptions', () => {
  test('watchFiles.paths: dir not found', () => {
    ...
    return watchExceptionContain('_exceptions/msg-exception-plugin-option-watchFiles-paths', containString);
  });
});
...
describe('warnings', () => {
  test('plugin-favicons', () => {
    ...
    return stdoutContain('_exceptions/msg-warning-plugin-favicons-no-href', containString);
  });
});
